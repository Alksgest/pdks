  ...
  private articles: Article[] = [
    {
      ...
      content:
        `
      <div>
      <h4 style="text-align:center">Незабудка</h4>
      <p></p>
      <p>
    ...
    },
    {
      ...
      content:
      `
      <h4 style="text-align:center">Масонское Братство Украины: масоны в Запорожье представлены ДЛ “Паломники в страну Востока” №17.</h4>
      <p></p>
      <div><p>Вы находитесь на информационном сайте нашей Достопочтенной Ложи.</p>
      ...
      dateTime: new Date(2019, 6, 25, 13, 15)
    }
  ];
